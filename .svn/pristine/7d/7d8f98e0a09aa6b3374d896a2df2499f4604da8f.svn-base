...
<head>
    ...
    <script>
     ...
     function go() {
		  ...
		  var siteList = ["mgwa.duzon.com", "mgwa1.duzon.com", "mgwa2.duzon.com"]; 
        ...
        <div id="example">
            	...
            	<ul id="fieldlist">  
            		<li> 
	                    ...
	                    <input class="k-textbox" id="requestPageUrl" name="requestPageUrl" value="/BizboxMobileGateway/test.jsp" style="width:600px"/> 
