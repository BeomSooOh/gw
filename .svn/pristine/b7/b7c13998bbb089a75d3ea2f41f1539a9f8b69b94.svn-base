...
//	var tree_hei=$(".treeTop").height();	 
	...
	} else if($(".record_tab").length > 0 && $(".record_tabSearch").length && $(".etc_folder").length )
	{
		$(".tree_auto").height(scw_hei - treetitle_hei);
	} else {
		$(".tree_auto").height(scw_hei - treetitle_hei - etc_folder_hei -11);
	}

	//$(".board_list").height(scw_hei - treetitle_hei);
