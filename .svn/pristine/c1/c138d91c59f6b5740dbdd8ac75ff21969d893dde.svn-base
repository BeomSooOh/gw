...
// 		    dataSource.query(query);
	     	  ...
	     	  transport: {
	     	    ...
	     	    parameterMap: function(data, operation) {
	     	    	...
	     	    	data.pDept = $("#txtManDept_S").val();		//상세검색(담당자부서)
	   	    		data.pGrade = $("#txtManGrade_S").val();	//상세검색(담당자직급)
	   	    		data.pName = $("#txtManNM_S").val();		//상세검색(담당자명)
		...
		function fnSave(r_no){
			var url = "visitorPopView.do?type=new&r_no="+r_no;
	    ...
	    function btnDetail(e){
	    	var url = "visitorPopView.do?r_no="+e.id;
		   	var left = (screen.width-958)/2;
		   	var top = (screen.height-753)/2;
...
<div class="SearchDetail">
	<dl>	
		...
		<dd class="mr5">
			<input id="txtManDept_S" type="text" value="" style="width:150px">
		</dd>
		<dt style="width:80px;"><%=BizboxAMessage.getMessage("TX000016332","담당자직급")%></dt>
		<dd class="mr5">
			<input id="txtManGrade_S" type="text" value="" style="width:150px">
		</dd>
