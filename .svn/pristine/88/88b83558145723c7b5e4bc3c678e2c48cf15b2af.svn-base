...
public class CmmnCodeManageDAO extends EgovComAbstractDAO {
	...
	public CmmnCode selectCmmnCodeDetail(CmmnCode cmmnCode) throws Exception {
		return (CmmnCode)select("CmmnCodeManageDAO.selectCmmnCodeDetail", cmmnCode);
	}
	...
	Map<String, Object> selectCmmnCodeList(Map<String, Object> paramMap , PaginationInfo paginationInfo){
		...
		return super.listOfPaging2(paramMap, paginationInfo, "CmmnCodeManageDAO.selectCmmnCodeList");
	...
	public String selectCcmCmmnCodeDc(String codeId) throws Exception {
		return (String)select("CmmnCodeManageDAO.selectCcmCmmnCodeDc", codeId);
	}
}
