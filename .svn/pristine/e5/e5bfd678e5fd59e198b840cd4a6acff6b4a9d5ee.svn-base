...
<head>
    ...
    var type = 0;
    	...
    	function userSelectPop() {
	    	...
	    	var pop = window.open("", "empInfoPop", "width=665,height=646,scrollbars=no");
        ...
        <div id="example">
            	...
            	<ul id="fieldlist">  
            		<li> 
	                    ...
	                    <input class="k-textbox" id="popUrlStr" name="popUrlStr" value="/gw/cmm/systemx/cmmOcType2Pop.do" style="width:600px"/> 
            		...
            		<li> 
	                    ...
	                    <textarea class="k-textbox" id="selectedOrgList" name="selectedOrgList" value="" style="width:800px; height:200px"></textarea>
	                </li>  
