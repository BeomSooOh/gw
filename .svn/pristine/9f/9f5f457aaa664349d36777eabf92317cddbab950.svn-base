...
console.log(e);//오류 상황 대응 부재
	 ...
	 * @returns {String}
	 */
	getCodeMultiList : function( codeID, langCode ) {
		var list = "" ;
		try {
	        $.ajax({
	            type: "POST",
	            url: getContextPath()+"/cmm/system/commonCodeMultiList.do",
	            async: false,
	            datatype: "text",
	            data: ({ codeID: codeID, langCode: langCode }),
	            success: function (data) {
	            	list =  data.list;
	            },
	            error: function (XMLHttpRequest, textStatus) {
...
console.log(e);//오류 상황 대응 부재
	 ...
	 * @returns {String}
	 */
	getChildCodeMultiList : function( codeID, langCode ) {
		var list = "" ;
		try {
	        $.ajax({
	            type: "POST",
	            url: getContextPath()+"/cmm/system/commonChildCodeMultiList.do",
	            async: false,
	            datatype: "text",
	            data: ({ codeID: codeID, langCode: langCode }),
	            success: function (data) {
