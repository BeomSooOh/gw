...
public class EgovFileMngServiceImpl extends EgovAbstractServiceImpl implements EgovFileMngService {
     ...
     * 
     * 
     * @see egovframework.com.cmm.service.EgovFileMngService#existsFileInf(egovframework.com.cmm.service.FileVO)
     */
    public boolean existsFileInf(FileVO fvo) throws Exception {
    	boolean isTrue = true ;
    	String atchFileID =  fileMngDAO.existsFileInf(fvo);
