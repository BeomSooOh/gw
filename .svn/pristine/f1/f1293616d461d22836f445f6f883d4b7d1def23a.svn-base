...
public class RestfulVO implements Serializable {
	...
	public List<Map<String,Object>> menuList = new ArrayList<Map<String,Object>>();	//대메뉴리스트 - 모바일 메뉴 다국어처리용
	public List<Map<String,Object>> functionList = new ArrayList<Map<String,Object>>();	//function List
	...
	public String getOnefficeReportUseYn() {
		return onefficeReportUseYn;
	}
	public void setOnefficeReportUseYn(String onefficeReportUseYn) {
		this.onefficeReportUseYn = onefficeReportUseYn;
	}
