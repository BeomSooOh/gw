...
public class RdnmadZipDAO extends EgovComAbstractDAO {
    ...
    public int selectZipListTotCnt(ZipVO searchVO) throws Exception {
        return (Integer)getSqlMapClientTemplate().queryForObject("RdnmadZipDAO.selectZipListTotCnt", searchVO);
    }
    ...
    public List searchPopZipList(String searchKeyword) throws Exception {
        return list("RdnmadZipDAO.searchPopZipList", searchKeyword);
    }
