...
<div class="pop_wrap" style="width:auto;">
    ...
    <div class="pop_con">
        <div class="Pop_border" style="height:295px;">
            <p class="borderB" style="height:24px; padding:15px;">
                <input class="k-textbox input_search"id="searchKeyword" name="searchKeyword" type="text" value="" style="width:348px;" placeholder="담당자검색">
    ...
    <div class="pop_foot">
        <div class="btn_cen pt12">
            ...
            <input type="button" id="btnCancle" class="gray_btn" value="취소" />
        </div>
    </div><!-- //pop_foot -->
    </div><!-- //pop_wrap -->
<div>
