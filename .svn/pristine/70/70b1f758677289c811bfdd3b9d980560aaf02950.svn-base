...
<div class="pop_wrap" style="width:368px;">
	...
	<div class="pop_foot">
		<div class="btn_cen pt12">
			<input type="button" id="ok" name="" class="" value="확인" />
			<input type="button" id="cancel" name="" class="gray_btn" value="취소" />
		</div>
	</div><!-- //pop_foot -->
</div><!-- //pop_wrap -->