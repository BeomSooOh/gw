...
<div class="mt30">
	...
	<div class="com_ta2 mt15">
		...
		<div class="com_ta2 ova_sc bg_lightgray orgChartSelectedItemList" style="height:148px;margin-top:0px;" id="div_org_selected_item_list2_us">
		...
		<div class="com_ta2 ova_sc bg_lightgray orgChartSelectedItemList" style="height:148px;margin-top:0px;" id="div_org_selected_item_list2_ds">
			<table class="tb_selected_item_list">
				<colgroup>
					<col width="160" />
					<col width="" />
		...
		<div class="com_ta2 ova_sc bg_lightgray orgChartSelectedItemList" style="height:148px;margin-top:0px;" id="div_org_selected_item_list2_um">
			<table class="tb_selected_item_list">
				<colgroup>
					<col width="34" />
					<col width="125" />
		...
		<div class="com_ta2 ova_sc bg_lightgray orgChartSelectedItemList" style="height:148px;margin-top:0px;" id="div_org_selected_item_list2_dm">
			<table class="tb_selected_item_list">
				<colgroup>
					<col width="34" />
					<col width="130" />
		...
		<div class="com_ta2 ova_sc bg_lightgray orgChartSelectedItemList" style="height:148px;margin-top:0px;" id="div_org_selected_item_list2_ud">
			<table class="tb_selected_item_list">
				<colgroup>
					<col width="34" />
					<col width="100" />
...
<script type="text/javascript">
	...
	function OJSI_fnSetSelectedItemList(defaultInfo, param) {
		...
		/* 테이블 로우 정보 삽입 */
		$('.tb_selected_item_list:visible > tbody:last').append(insertRowHtml);
