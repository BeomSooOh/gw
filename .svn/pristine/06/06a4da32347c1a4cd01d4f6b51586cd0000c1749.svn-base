...
<form id="frmPop" name="frmPop">
	...
	<input type="hidden" name="initMode" id="initMode" value="N" />
	...
	<input type="hidden" name="noUseCompSelect" value="true" />
</form>					



										<div class="tb_borderB pl15 pr15 clear">
											<p class="tit_p fl mt14"><%=BizboxAMessage.getMessage("TX000016250","부서목록")%> </p>
											
											<div class="controll_btn fr">
												<button type="button" id="btnTree"><%=BizboxAMessage.getMessage("TX000002687","부서선택")%></button>
										...
										<div class="tb_borderB pl15 pr15 clear bg_lightgray">
											<p class="tit_p fl mt14"><%=BizboxAMessage.getMessage("TX000000098","부서")%></p>
										...
										<div class="com_ta2 mt15 ml15 mr15">
											<table>
												...
												<tr>
													...
													<th><%=BizboxAMessage.getMessage("TX000004908","상위부서명")%></th>
