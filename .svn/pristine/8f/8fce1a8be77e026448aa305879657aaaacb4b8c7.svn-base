...
public class RestdeManageDAO extends EgovComAbstractDAO {
	 ...
	 * @throws Exception
	 */
	public void deleteRestde(String restdeNo) throws Exception {
		delete("RestdeManageDAO.deleteRestde", restdeNo);
	}
	 ...
	 * 휴일 설명을 불러온다.
	 */
	public String selectRestdeDc(String restdeNo) throws Exception {
		return (String)select("RestdeManageDAO.selectRestdeDc", restdeNo);
	}
