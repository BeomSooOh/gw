...
<body class="<c:if test="${portalDiv == 'cloud'}">freeb_</c:if>main_bg"> 
	<!-- Header --> 
	<div class="<c:if test="${portalDiv == 'cloud'}">freeb_</c:if>header_wrap">
		<jsp:include page="/topGnb.do?type=main&mainPortalYn=${mainPortalYn}&portalDiv=${portalDiv}" /> 
	</div>
	<!-- //End of Header -->
