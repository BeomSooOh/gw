...
<div class="sub_contents_wrap">
	...
	<span class="mR10"><select name="selectTerm" id="selectTerm" title='<spring:message code="search.term" />' ${isUseDateSearch }>
...
<!-- 				<option value="6month">6달</option> -->
		...
		<input type="text" name="c_startDate" id="c_startDate" ${isUseDateSearch }
			size="13" maxlength="14" value="${searchParamVO.c_startDate_origin }" style="width:150px;" />~ 
		<input type="text" name="c_endDate" id="c_endDate" size="13" ${isUseDateSearch }
			maxlength="14" value="${searchParamVO.c_endDate_origin }" style="width:150px;"/>
		<select id="selectSearchType"
			name="selectSearchType" title='<spring:message code="search.searchtype"/>' style="width:70px;" />'>
		...
		<input type="text" name="searchText" id="searchText" class="searchText"
			value="${searchParamVO.searchText }" size="20" maxlength="12"  style="width:180px;"/>
		
		<select id="signtype_select"
			name="signtype_select" style="display: none" title='<spring:message code="search.term" />'>
		...
		<option value="postpone">보류</option> -->
            ...
            <span class="btn_Detail">
                  상세 <img id="all_menu_btn" src="<c:url value='/Images/ico/ico_btn_arr_down01.png'/>" alt="상세" />
            </span>
    </div>    
 ...
 */
		...
		<c:choose>
            ...
            $("#c_startDate").kendoDatePicker( {
                format : "yyyy-MM-dd",
                culture : "ko-KR"
            });
            $("#c_endDate").kendoDatePicker( {
                format : "yyyy-MM-dd",
                culture : "ko-KR"
            });
			</c:when>
