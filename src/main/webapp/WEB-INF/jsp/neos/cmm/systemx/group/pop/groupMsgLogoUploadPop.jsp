	...
	for(var i=0;i<arrFileList.length;i++){
		...
		if (fileId != null && fileId != '') {
			...
			$.ajax({
				...
				datatype:"json",
				async:false,
				data: {imgType:fileNm,orgSeq:'${orgSeq}',fileId : fileId, osType : osType, appType : appType},
				success:function(data){					
				},			
				error : function(e){	//error : function(xhr, status, error) {
					alert("error");	
...
<div class="pop_wrap" style="width:558px;">
	...
	<input type="hidden" id="page" name="page" value="/cmm/systemx/groupMsgLogoUploadPop.do" >
	<div class="pop_head">
	...
	<div class="pop_con">	
		<p class="mb10"><%=BizboxAMessage.getMessage("TX000016449","※ 현재 등록된 이미지 버전")%> : 0.1</p>
		<div class="com_ta2 hover_no">
			<table>
				...
				<tr>
					<td class="le"><%=BizboxAMessage.getMessage("TX000016315","로그인 로고")%>&nbsp;<img id="btndown_inp_files1" style="display: none;cursor:pointer;" onclick="fnDown(this);" src="/gw/Images/btn/btn_download01.png" alt="" /> <br /> <span class="f11 text_gray">(180*30)</span> </td>
					<td>
						<div class="file_chum_box">
							<input name="MSG_LOGO_01" id="inp_files1" type="file"/>	
						</div>			
					</td>
				</tr>
				<tr>
					<td class="le"><%=BizboxAMessage.getMessage("TX000016292","메인 상단 로고")%>&nbsp;<img id="btndown_inp_files2" style="display: none;cursor:pointer;" onclick="fnDown(this);" src="/gw/Images/btn/btn_download01.png" alt="" /> <br /> <span class="f11 text_gray">(71*12)</span> </td>
					<td>
						<div class="file_chum_box">
							<input name="MSG_LOGO_02" id="inp_files2" type="file"/>
						</div>			
					</td>
				</tr>
