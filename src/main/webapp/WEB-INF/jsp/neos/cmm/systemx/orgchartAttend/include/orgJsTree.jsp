...
<script type="text/javascript">
	...
	function openNode(empDeptFlag, deptSeq){
		...
		$('#orgTreeView_oc').jstree("select_node", empDeptFlag + deptSeq);		
		...
		filterdData.containsKey(key)
				|| $
						.ajax({
							async : false,
							type : "post",
							url : '<c:url value="/cmm/systemx/GetFilterdUserDeptProfileListForDeptAttend.do" />',
							dataType : "json",
							data : param,
