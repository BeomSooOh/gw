...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
 	...
 	<div class="com_ta2">
		...
		<div class="com_ta2 ova_sc bg_lightgray orgChartSelectedItemList" style="height:200px;margin-top:0px;" id="div_org_selected_item_list2_us">
		...
		<div class="com_ta2 ova_sc bg_lightgray orgChartSelectedItemList" style="height:200px;margin-top:0px;" id="div_org_selected_item_list2_um">
			<table class="tb_selected_item_list">
				<colgroup>
					<col width="34" />
					<col width="125" />
		...
		<div class="com_ta2 ova_sc bg_lightgray orgChartSelectedItemList" style="height:200px;margin-top:0px;" id="div_org_selected_item_list2_ds">
			<table class="tb_selected_item_list">
				<colgroup>
					<col width="160" />
					<col width="" />
		...
		<div class="com_ta2 ova_sc bg_lightgray orgChartSelectedItemList" style="height:200px;margin-top:0px;" id="div_org_selected_item_list2_dm">
			<table class="tb_selected_item_list">
				<colgroup>
					<col width="34" />
					<col width="130" />
		...
		<div class="com_ta2 ova_sc bg_lightgray orgChartSelectedItemList" style="height:200px;margin-top:0px;" id="div_org_selected_item_list2_ud">
			<table class="tb_selected_item_list">
				<colgroup>
					<col width="34" />
					<col width="100" />
		...
		<div class="com_ta2 ova_sc bg_lightgray orgChartSelectedItemList1" style="height:200px;margin-top:0px;" id="div_org_selected_item_list2_us1">
		...
		<div class="com_ta2 ova_sc bg_lightgray orgChartSelectedItemList1" style="height:200px;margin-top:0px;" id="div_org_selected_item_list2_um1">
			<table class="tb_selected_item_list1">
				<colgroup>
					<col width="34" />
					<col width="125" />
		...
		<div class="com_ta2 ova_sc bg_lightgray orgChartSelectedItemList1" style="height:200px;margin-top:0px;" id="div_org_selected_item_list2_ds1">
			<table class="tb_selected_item_list1">
				<colgroup>
					<col width="160" />
					<col width="" />
		...
		<div class="com_ta2 ova_sc bg_lightgray orgChartSelectedItemList1" style="height:200px;margin-top:0px;" id="div_org_selected_item_list2_dm1">
			<table class="tb_selected_item_list1">
				<colgroup>
					<col width="34" />
					<col width="130" />
		...
		<div class="com_ta2 ova_sc bg_lightgray orgChartSelectedItemList1" style="height:200px;margin-top:0px;" id="div_org_selected_item_list2_ud1">
			<table class="tb_selected_item_list1">
				<colgroup>
					<col width="34" />
					<col width="100" />
...
/* [중복 제거] 사용 선택 시 중복제거 */
function OJSI_fnSetSelectedDuplicateItemList(defaultInfo) {
