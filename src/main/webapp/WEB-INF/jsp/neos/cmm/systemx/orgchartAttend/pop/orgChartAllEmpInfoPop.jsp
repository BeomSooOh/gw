...
<script type="text/javascript">
	...
	function fnClickUserInfo(comp_seq, dept_seq, emp_seq) {
		...
		if(initFlag) {
			//console.log("dddddd : " + $("#" + emp_seq).offset().top);
...
<div class="pop_wrap" style="width: 898px;">
	...
	<div class="pop_con">
		...
		<div class="fl ml10" style="width: 606px;">
			<!-- 검색 기능버튼 -->
			<div class="top_box">
				<div class="top_box_in">
					<div id="" class="dod_search posi_re">
						...
						<input type="text" class=""id="searchText" style="width:250px;text-indent:4px;"/>
...
<%-- 							<col width="34" /> --%>
						...
						<tbody id="userInfo">
<!-- 							<tr> -->
<!-- 								<td><input type="checkbox" name="chk" id="chk_1" -->
<!-- 									class="k-checkbox"> <label -->
<!-- 									class="k-checkbox-label bdChk" for="chk_1"></label></td> -->
<!-- 								<td>개발1팀</td> -->
<!-- 								<td>대리</td> -->
<!-- 								<td>팀원</td> -->
<!-- 								<td>유난주</td> -->
...
<!-- 							</tr> -->
			...
			<div class="mt20">
				...
				<div class="ovh">
					...
					<div class=" fl" style="width: 414px;">
						<div class="com_ta">
							<table>
								<colgroup>
									<col width="90" />
								...
								<tr>
									<th><%=BizboxAMessage.getMessage("","전체부서")%></th>
								...
								<tr>
									<th><%=BizboxAMessage.getMessage("","회사메일")%></th>
									<td colspan="3" id="compMail"></td>
								</tr>
								
								<tr>
									<th><%=BizboxAMessage.getMessage("","개인메일")%></th>
