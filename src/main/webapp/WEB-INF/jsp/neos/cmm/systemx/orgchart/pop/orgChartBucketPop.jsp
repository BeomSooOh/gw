...
<script type="text/javascript">
	...
	var exMyinfoYn = '${params.exMyinfoYn}';	//내정보 표시여부
	var targetDeptSeq = '${params.targetDeptSeq}';	//특정 부서만 표시 옵션
	...
	$(document).ready(function() {
		...
		paramSet.nodeChageEvent =  selectMode.toLowerCase() == 'od' ? '' : 'OJTC_fnGetEmpDeptList';
		...
		paramSet.targetDeptSeq = targetDeptSeq || '';
	...
	function fnSetTitleTxt(defaultInfo) {
		if (defaultInfo.selectMode === 'u') {
			...
			$('#txt_orgTitle').html('<%=BizboxAMessage.getMessage("TX900000486","사업장 선택")%>');
		}
	}
			...
			<tr>
				...
				<td>
					<div class="box_right2 ml10 mt10" style="width:auto;height:auto;">
						<!--   파츠C   -->
						<jsp:include page="../include/orgJsItemList.jsp" flush="false" />
						<!--   파츠D   -->
						<jsp:include page="../include/orgJsSelectedItemList.jsp" flush="false" />
					</div>
				</td>
			</tr>
		</table>		
