...
<script type="text/javascript">
	...
	<div class="contents_wrap" style="top:-1px"> 
		...
		<div class="footer">
			<c:if test="${orgBtn == 'Y'}">
			<ul class="sub_etc"><li><a href="javascript:;" onclick="orgChartPop();"><span class="t2">&nbsp;</span><%=BizboxAMessage.getMessage("TX000004738","조직도")%></a></li></ul>
			</c:if>			
		</div>
	</div> 
