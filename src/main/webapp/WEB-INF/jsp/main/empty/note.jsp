...
<div class="M_note ptl mb8">
	<h2 class="notebg"><%=BizboxAMessage.getMessage("TX000010157","노트")%></h2>
	...
	<div class="LR_nocon acvm"><%=BizboxAMessage.getMessage("TX000008504","내용 준비중 입니다.")%></div>
</div>