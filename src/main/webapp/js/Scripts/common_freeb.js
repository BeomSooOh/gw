...
function npDocList(){
	...
	if( $(".freeb_sub_contents").length > 0 ){
		//scw_hei = $(".freeb_contents_wrap").height();
...
function custTopReset(){
	
    if($(".header_sub_wrap") != null && $(".header_sub_wrap").length > 0){
    	var customTop = $(".header_sub_wrap").offset().top + 52;
		$(".freeb_contents_wrap").css("top", customTop);            
	}
