...
function readyInfo() {
	alert(NeosUtil.getMessage("TX000011130","죄송합니다. 서비스 준비중입니다."));	
}
...
//         .append('<tr class="kendo-data-row"><td colspan="' + colCount+ '" class="no-data" style="text-align: center;">데이터가 존재하지 않습니다.</td></tr>');
     .append('<tr class="kendo-data-row"><td colspan="' + colCount+ '" class="no-data" style="text-align: center;">'+NeosUtil.getMessage("TX000010608","데이터가 존재하지 않습니다")+'</td></tr>');
 }
};	
