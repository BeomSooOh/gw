...
var dzeUiConfig = {
	...
	// data binding
	bUseDataBind: true,
	bUseDataBindTwoWay: true,    //양방향 데이터 바인딩 (UCDOC-1719)
	...
	//--------------------------------------------------------------------------------------- 셀 편집제한 모드 설정 여부
	nCustomLockEditCellMode: true,	// true - 셀 편집제한 기능 제공(관리자), false - 셀 편집제한 기능 제공 안함(사용자)
	
	//--------------------------------------------------------------------------------------- 테이블 편집제한 모드 설정 여부
	nLockEditTableMode: true,		// true - 테이블 편집제한 기능 제공(관리자), false - 테이블 편집제한 기능 제공 안함(사용자)
