...
<script>
	$(document).ready(function() {
		...
		if($('input[name=targetDeptSeq]').val() == "null"){
...
<body style="margin :0px; padding: 0px;">
	<div class="pop_wrap">
		...
		<input type="hidden" name="noUseExtendArea" width="500" value="<%=request.getParameter("noUseExtendArea")%>"/>
		<input type="hidden" name="exMyinfoYn" width="500" value="<%=request.getParameter("exMyinfoYn")%>"/>
		<input type="hidden" name="targetDeptSeq" width="500" value="<%=request.getParameter("targetDeptSeq")%>"/>
		</form>
