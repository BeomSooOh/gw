...
<script>
	$(document).ready(function() {
		if('<%=request.getParameter("devMode")%>' === 'dev'){
			$('#form').attr('action','http://bizboxa.duzonnext.com/gw/systemx/orgChart.do');
...
<body style="margin :0px; padding: 0px;">
	<div class="pop_wrap">
		...
		<input type="hidden" name="selectMainTitle" width="500" 	value="<%=request.getParameter("selectMainTitle")%>"/>
		<input type="hidden" name="selectedItems" width="500" 	value="<%=request.getParameter("selectedItems")%>"/>
		<input type="hidden" name="selectedItems1" width="500" 	value="<%=request.getParameter("selectedItems1")%>"/>
		<input type="hidden" name="selectedItems2" width="500" 	value="<%=request.getParameter("selectedItems2")%>"/>
		...
		<input type="hidden" name="extendSelectAreaCount" width="500" value="<%=request.getParameter("extendSelectAreaCount")%>"/>
		<input type="hidden" name="extendSelectAreaInfo" width="500" value="<%=request.getParameter("extendSelectAreaInfo")%>"/>
