...
public class EgovComCrossSiteHndlr extends BodyTagSupport {
	...
	private static final String MSDIFFCHAR ="()[]{}\"',:;= \t\r\n%!+-";
	
	private static final String m_sArrDiffChar [] = {
						"&#40;","&#41;",
						"&#91;","&#93;",
						"&#123;","&#125;",
						"&#34;","&#39;",
	...
	public static void out2(PageContext pageContext,
			Object obj) throws IOException {
		JspWriter w = pageContext.getOut();
	...
	private String getWriteEscapedXml() throws IOException {
		...
		//String sDiffChar
		//String sArrDiffChar
		char[] cDiffChar =  this.MSDIFFCHAR.toCharArray();
