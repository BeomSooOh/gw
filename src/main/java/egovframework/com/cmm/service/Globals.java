 ...
 *   2016.01.07    한용일          BizboxA 설정으로 변경
 *
...
public class Globals {
	//OS 유형
    public static final String OS_TYPE = BizboxAProperties.getProperty("BizboxA.OsType");
    //DB 유형
    public static final String DB_TYPE = BizboxAProperties.getProperty("BizboxA.DbType");
    
    public static final String ERP_TYPE = BizboxAProperties.getProperty("BizboxA.ErpType");
    //메인 페이지
    public static final String MAIN_PAGE = BizboxAProperties.getProperty("BizboxA.MainPage");
    //ShellFile 경로
