...
public class EgovCcmRdnmadZipServiceImpl extends AbstractServiceImpl implements EgovCcmRdnmadZipManageService {
	...
	public void insertExcelZip(InputStream file) throws Exception {
		...
		excelRdnmadZipService.uploadExcel("RdnmadZipDAO.insertExcelZip", file, 1, (long) 5000); 
	}
	...
	public Zip selectZipDetail(Zip zip) throws Exception {
    	Zip ret = (Zip)rdnmadZipDAO.selectZipDetail(zip);
    	return ret;
	}
	 ...
	 * 우편번호 조회
	 */
	public List searchPopZipList(String searchKeyword)  throws Exception {
        return rdnmadZipDAO.searchPopZipList(searchKeyword);
	}
}
